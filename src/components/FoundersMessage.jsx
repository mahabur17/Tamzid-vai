...
export default function FoundersMessage() {
  ...
  const phoneNumber = "8801957747041"; // হোয়াটসঅ্যাপ নম্বর
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="bg-surface-container-lowest rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-16 flex flex-col md:flex-row gap-8 md:gap-16 items-center shadow-[0_40px_80px_rgba(1,45,29,0.06)] text-center md:text-left">
                ...
                <div className="space-y-3 md:space-y-4 flex flex-col items-center md:items-start">
                    ...
                    {/* সোশ্যাল মিডিয়া আইকন সেকশন */}
                    <div className="flex gap-4 pt-4 md:pt-6">
                        
                        {/* ফেসবুক - target="_blank" সরানো হয়েছে */}
                        <a href="https://www.facebook.com/tamzid.islam.5243" className="p-3 bg-primary/10 rounded-full text-primary hover:bg-primary hover:text-white transition-all duration-300" title="Facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                        </a>

                        {/* হোয়াটসঅ্যাপ - এখানে target="_blank" রাখা ঠিক আছে কারণ এটি API লিংক */}
                        ...
                        {/* ইউটিউব - target="_blank" সরানো হয়েছে যাতে ব্যাক করলে ওয়েবসাইটে ফেরে */}
                        <a href="#" className="p-3 bg-primary/10 rounded-full text-primary hover:bg-primary hover:text-white transition-all duration-300" title="YouTube">
